	...
	<div class="main-containers">
		...
		<div class="top-container" :style='{"boxShadow":"0 0px 0px rgba(64, 158, 255, .3)","padding":"0 7%","borderColor":"#eee","alignItems":"center","color":"#fff","textAlign":"right","display":"flex","justifyContent":"flex-end","overflow":"hidden","top":"0","borderRadius":"0","left":"0","background":"#111","borderWidth":"0px","width":"100%","fontSize":"14px","lineHeight":"32px","position":"relative","borderStyle":"solid","height":"36px","zIndex":"1002"}'>
			...
			<div :style='{"margin":"0","left":"7%","display":"inline-block","width":"auto","position":"absolute","float":"left","height":"32px"}'>
			  <span @click="goMenu('/index/home')" :style='{"padding":"0px","color":"inherit","alignItems":"center","display":"flex","width":"100%","lineHeight":"1.5","fontSize":"26px","float":"left","fontWeight":"600","height":"32px"}'>高校学术交流平台</span>
			</div>
...
export default {
    data() {
		return {
            activeIndex: '0',
			roleMenus: [{"backMenu":[{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-similar","buttons":["新增","查看","修改","删除"],"menu":"用户","menuJump":"列表","tableName":"yonghu"}],"menu":"用户管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-flashlightopen","buttons":["新增","查看","修改","删除"],"menu":"学术主题类型","menuJump":"列表","tableName":"xueshuzhutileixing"}],"menu":"学术主题类型管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-send","buttons":["新增","查看","修改","删除"],"menu":"活动类型","menuJump":"列表","tableName":"huodongleixing"}],"menu":"活动类型管理"},{"child":[{"allButtons":["新增","查看","修改","删除","查看评论","报名"],"appFrontIcon":"cuIcon-present","buttons":["新增","查看","修改","删除","查看评论"],"menu":"学术活动","menuJump":"列表","tableName":"xueshuhuodong"}],"menu":"学术活动管理"},{"child":[{"allButtons":["新增","查看","修改","删除","查看评论"],"appFrontIcon":"cuIcon-cardboard","buttons":["新增","查看","修改","删除","查看评论"],"menu":"论文","menuJump":"列表","tableName":"lunwen"}],"menu":"论文管理"},{"child":[{"allButtons":["新增","查看","修改","删除","审核"],"appFrontIcon":"cuIcon-news","buttons":["查看","删除","审核"],"menu":"活动报名","menuJump":"列表","tableName":"huodongbaoming"}],"menu":"活动报名管理"},{"child":[{"allButtons":["新增","查看","修改","删除","用户数量","论文数量","首页总数","首页统计"],"appFrontIcon":"cuIcon-circle","buttons":["新增","查看","修改","删除","首页总数","首页统计"],"menu":"数据统计","menuJump":"列表","tableName":"shujutongji"}],"menu":"数据统计管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-group","buttons":["新增","查看","修改","删除"],"menu":"学术论坛","tableName":"forum"}],"menu":"学术论坛"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-flashlightopen","buttons":["新增","查看","修改","删除"],"menu":"轮播图管理","tableName":"config"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"公告信息","tableName":"news"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"公告信息分类","tableName":"newstype"}],"menu":"系统管理"}],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","查看评论","报名"],"appFrontIcon":"cuIcon-circle","buttons":["查看","报名"],"menu":"学术活动列表","menuJump":"列表","tableName":"xueshuhuodong"}],"menu":"学术活动模块"},{"child":[{"allButtons":["新增","查看","修改","删除","查看评论"],"appFrontIcon":"cuIcon-wenzi","buttons":["查看"],"menu":"论文列表","menuJump":"列表","tableName":"lunwen"}],"menu":"论文模块"}],"hasBackLogin":"是","hasBackRegister":"否","hasFrontLogin":"否","hasFrontRegister":"否","roleName":"管理员","tableName":"users"},{"backMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","审核"],"appFrontIcon":"cuIcon-news","buttons":["查看","删除"],"menu":"活动报名","menuJump":"列表","tableName":"huodongbaoming"}],"menu":"活动报名管理"}],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","查看评论","报名"],"appFrontIcon":"cuIcon-circle","buttons":["查看","报名"],"menu":"学术活动列表","menuJump":"列表","tableName":"xueshuhuodong"}],"menu":"学术活动模块"},{"child":[{"allButtons":["新增","查看","修改","删除","查看评论"],"appFrontIcon":"cuIcon-wenzi","buttons":["查看"],"menu":"论文列表","menuJump":"列表","tableName":"lunwen"}],"menu":"论文模块"}],"hasBackLogin":"否","hasBackRegister":"否","hasFrontLogin":"是","hasFrontRegister":"是","roleName":"用户","tableName":"yonghu"}],
			baseUrl: '',
			carouselList: [],
			menuList: [],
			form: {
