		...
		<div class="attr" :style='{"padding":"0","margin":"0","flexWrap":"wrap","background":"none","flex":"1","display":"flex","width":"48%","position":"relative","justifyContent":"space-between","order":"2"}'>
			...
			<div class="info" :style='{"minHeight":"460px","padding":"0","margin":"0","borderRadius":"0px","flexWrap":"wrap","background":"#dff4ff","display":"flex","width":"100%","justifyContent":"space-between","order":"2"}'>
				...
				<div class="item" :style='{"padding":"0 20px","margin":"0 0 4px 0","borderColor":"#28890b10","background":"none","borderWidth":"0px","display":"flex","width":"48%","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","whiteSpace":"nowrap","color":"#333","borderRadius":"20px","textAlign":"center","background":"#fff","width":"auto","fontSize":"13px","lineHeight":"24px","minWidth":"80px","fontWeight":"500","height":"24px"}'>统计日期</div>
					<div  :style='{"padding":"0px 10px 0","wordBreak":"break-all","color":"#333","flex":"1","fontSize":"14px","lineHeight":"24px","height":"auto"}'>{{detail.tongjiriqi}}</div>
				</div>
				<div class="item" :style='{"padding":"0 20px","margin":"0 0 4px 0","borderColor":"#28890b10","background":"none","borderWidth":"0px","display":"flex","width":"48%","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","whiteSpace":"nowrap","color":"#333","borderRadius":"20px","textAlign":"center","background":"#fff","width":"auto","fontSize":"13px","lineHeight":"24px","minWidth":"80px","fontWeight":"500","height":"24px"}'>用户数量</div>
					<div  :style='{"padding":"0px 10px 0","wordBreak":"break-all","color":"#333","flex":"1","fontSize":"14px","lineHeight":"24px","height":"auto"}'>{{detail.yonghushuliang}}</div>
				</div>
				<div class="item" :style='{"padding":"0 20px","margin":"0 0 4px 0","borderColor":"#28890b10","background":"none","borderWidth":"0px","display":"flex","width":"48%","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","whiteSpace":"nowrap","color":"#333","borderRadius":"20px","textAlign":"center","background":"#fff","width":"auto","fontSize":"13px","lineHeight":"24px","minWidth":"80px","fontWeight":"500","height":"24px"}'>论文发布数量</div>
					<div  :style='{"padding":"0px 10px 0","wordBreak":"break-all","color":"#333","flex":"1","fontSize":"14px","lineHeight":"24px","height":"auto"}'>{{detail.lunwenfabushuliang}}</div>
				</div>
				<div class="btn" :style='{"width":"100%","padding":"0 20px","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"0px solid #009cf530","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"2px","background":"#009cf5","width":"auto","lineHeight":"36px","fontSize":"14px","height":"36px"}' v-if="btnAuth('shujutongji','修改')" @click="editClick">修改</el-button>
					<el-button :style='{"border":"0px solid #f5340030","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"2px","background":"#f53400","width":"auto","lineHeight":"36px","fontSize":"14px","height":"36px"}' v-if="btnAuth('shujutongji','删除')" @click="delClick">删除</el-button>
					<el-button :style='{"border":"0px solid #f5340030","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"2px","background":"#f53400","width":"auto","lineHeight":"36px","fontSize":"14px","height":"36px"}' v-if="btnAuth('shujutongji','私聊')&&detail.id!=mid" @click="chatClick">联系TA</el-button>
				</div>
			</div>
		</div>
