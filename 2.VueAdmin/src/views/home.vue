...
<div class="content" :style='{"minHeight":"100vh","padding":"30px","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20240414/b272aea717df4bbe8386c71c24c14e6e.png) no-repeat center top / cover","display":"flex","width":"100%","height":"auto"}'>
	...
	<div :style='{"width":"50%","margin":"0","grid-template-columns":"repeat(2,1fr)","display":"grid","rowGap":"20px","order":"2"}'>
		<div :style='{"boxShadow":"0 1px 6px rgba(0,0,0,.3)","margin":"0 10px","borderRadius":"4px","alignItems":"center","background":"#fff","display":"flex","position":"relative","justifyContent":"center"}' v-if="isAuth('shujutongji','首页总数')">
	...
	<!-- echarts -->
	<!-- 2 -->
	<div class="type2" :style='{"alignContent":"flex-start","padding":"0","margin":"20px 0 0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","height":"auto","order":"3"}'>
